...
{
    ed25519_field_element X;
    ed25519_field_element Y;
    ed25519_field_element Z;
} ed25519_group_element_projective;

typedef struct ed25519_group_element_extended
{
    ed25519_field_element X;
    ed25519_field_element Y;
    ed25519_field_element Z;
...
typedef struct ed25519_group_element_completed
{
    ...
    ed25519_field_element Z;
    ed25519_field_element T;
} ed25519_group_element_completed;

typedef struct ed25519_group_element_precompleted
{
    ed25519_field_element YPlusX;
    ed25519_field_element YMinusX;
    ed25519_field_element XY2D;
} ed25519_group_element_precompleted;

typedef struct ed25519_group_element_cached
{
    ed25519_field_element YPlusX;
    ed25519_field_element YMinusX;
    ed25519_field_element Z;
...
global ed25519_group_element_precompleted GlobalEd25519PrecomputedBase[32][8] = {
    {
        {
            { 25967493, -14356035, 29566456, 3660896, -12694345, 4014787, 27544626, -11754271, -6079156, 2047605 },
            { -12545711, 934262, -2722910, 3049990, -727428, 9406986, 12720692, 5043384, 19500929, -15469378 },
...
Ed25519PrecompletedMove(ed25519_group_element_precompleted *Precompleted, ed25519_group_element_precompleted *Precomputed, u8 B)
{
    ...
    Ed25519FieldElementMove(Precompleted->YMinusX, Precomputed->YMinusX, B);
...
Ed25519Negative(s8 B) 
{
    ...
    Result >>= 63; /* 1: yes; 0: no */
    return (u8) Result;
}

internal void
Ed25519GroupElementSelect(ed25519_group_element_precompleted *Precompleted, u32 Position, s8 B)
{
    ed25519_group_element_precompleted MinusPrecompleted;
    u8 NegativeB = Ed25519Negative(B);
    u8 AbsoluteB = B - (((-NegativeB) & B) << 1);
    Ed25519FieldElementSet1(Precompleted->YPlusX);
    Ed25519FieldElementSet1(Precompleted->YMinusX);
    Ed25519FieldElementSet0(Precompleted->XY2D);
    Ed25519PrecompletedMove(Precompleted, &GlobalEd25519PrecomputedBase[Position][0], Ed25519Equal(AbsoluteB, 1));
    Ed25519PrecompletedMove(Precompleted, &GlobalEd25519PrecomputedBase[Position][1], Ed25519Equal(AbsoluteB, 2));
    Ed25519PrecompletedMove(Precompleted, &GlobalEd25519PrecomputedBase[Position][2], Ed25519Equal(AbsoluteB, 3));
    Ed25519PrecompletedMove(Precompleted, &GlobalEd25519PrecomputedBase[Position][3], Ed25519Equal(AbsoluteB, 4));
    Ed25519PrecompletedMove(Precompleted, &GlobalEd25519PrecomputedBase[Position][4], Ed25519Equal(AbsoluteB, 5));
    Ed25519PrecompletedMove(Precompleted, &GlobalEd25519PrecomputedBase[Position][5], Ed25519Equal(AbsoluteB, 6));
    Ed25519PrecompletedMove(Precompleted, &GlobalEd25519PrecomputedBase[Position][6], Ed25519Equal(AbsoluteB, 7));
    Ed25519PrecompletedMove(Precompleted, &GlobalEd25519PrecomputedBase[Position][7], Ed25519Equal(AbsoluteB, 8));
    Ed25519FieldElementCopy(MinusPrecompleted.YPlusX, Precompleted->YMinusX);
    Ed25519FieldElementCopy(MinusPrecompleted.YMinusX, Precompleted->YPlusX);
    Ed25519FieldElementNegative(MinusPrecompleted.XY2D, Precompleted->XY2D);
    Ed25519PrecompletedMove(Precompleted, &MinusPrecompleted, NegativeB);
}
...
{
    ed25519_field_element t0;
    Ed25519FieldElementAdd(Completed->X, Extended->Y, Extended->X);
    Ed25519FieldElementSubtract(Completed->Y, Extended->Y, Extended->X);
    Ed25519FieldElementMultiply(Completed->Z, Completed->X, Cached->YPlusX);
    Ed25519FieldElementMultiply(Completed->Y, Completed->Y, Cached->YMinusX);
    Ed25519FieldElementMultiply(Completed->T, Cached->T2D, Extended->T);
    Ed25519FieldElementMultiply(Completed->X, Extended->Z, Cached->Z);
    Ed25519FieldElementAdd(t0, Completed->X, Completed->X);
    Ed25519FieldElementSubtract(Completed->X, Completed->Z, Completed->Y);
    Ed25519FieldElementAdd(Completed->Y, Completed->Z, Completed->Y);
    Ed25519FieldElementAdd(Completed->Z, t0, Completed->T);
                            ...
                            ed25519_group_element_cached *Cached)
{
    ...
    Ed25519FieldElementAdd(Completed->X, Extended->Y, Extended->X);
    Ed25519FieldElementSubtract(Completed->Y, Extended->Y, Extended->X);
    Ed25519FieldElementMultiply(Completed->Z, Completed->X, Cached->YMinusX);
    Ed25519FieldElementMultiply(Completed->Y, Completed->Y, Cached->YPlusX);
    Ed25519FieldElementMultiply(Completed->T, Cached->T2D, Extended->T);
    Ed25519FieldElementMultiply(Completed->X, Extended->Z, Cached->Z);
    Ed25519FieldElementAdd(t0, Completed->X, Completed->X);
    Ed25519FieldElementSubtract(Completed->X, Completed->Z, Completed->Y);
    Ed25519FieldElementAdd(Completed->Y, Completed->Z, Completed->Y);
    Ed25519FieldElementSubtract(Completed->Z, t0, Completed->T);
                               ...
                               ed25519_group_element_precompleted *Precompleted)
{
    ...
    Ed25519FieldElementAdd(Completed->X, Extended->Y, Extended->X);
    Ed25519FieldElementSubtract(Completed->Y, Extended->Y, Extended->X);
    Ed25519FieldElementMultiply(Completed->Z, Completed->X, Precompleted->YPlusX);
    Ed25519FieldElementMultiply(Completed->Y, Completed->Y, Precompleted->YMinusX);
    Ed25519FieldElementMultiply(Completed->T, Precompleted->XY2D, Extended->T);
    Ed25519FieldElementAdd(t0, Extended->Z, Extended->Z);
    Ed25519FieldElementSubtract(Completed->X, Completed->Z, Completed->Y);
    Ed25519FieldElementAdd(Completed->Y, Completed->Z, Completed->Y);
    Ed25519FieldElementAdd(Completed->Z, t0, Completed->T);
    Ed25519FieldElementSubtract(Completed->T, t0, Completed->T);
                                    ...
                                    ed25519_group_element_precompleted *Precompleted)
{
    ...
    Ed25519FieldElementAdd(Completed->X, Extended->Y, Extended->X);
    Ed25519FieldElementSubtract(Completed->Y, Extended->Y, Extended->X);
    Ed25519FieldElementMultiply(Completed->Z, Completed->X, Precompleted->YMinusX);
    Ed25519FieldElementMultiply(Completed->Y, Completed->Y, Precompleted->YPlusX);
    Ed25519FieldElementMultiply(Completed->T, Precompleted->XY2D, Extended->T);
    Ed25519FieldElementAdd(t0, Extended->Z, Extended->Z);
    Ed25519FieldElementSubtract(Completed->X, Completed->Z, Completed->Y);
    Ed25519FieldElementAdd(Completed->Y, Completed->Z, Completed->Y);
...
Ed25519FieldElementFromBytes(ed25519_field_element A, u8 *Bytes)
{
    ...
    s64 A1 = Ed25519ScalarLoad3(Bytes + 4) << 6;
    s64 A2 = Ed25519ScalarLoad3(Bytes + 7) << 5;
    s64 A3 = Ed25519ScalarLoad3(Bytes + 10) << 3;
    s64 A4 = Ed25519ScalarLoad3(Bytes + 13) << 2;
    s64 A5 = Ed25519ScalarLoad4(Bytes + 16);
    s64 A6 = Ed25519ScalarLoad3(Bytes + 20) << 7;
    s64 A7 = Ed25519ScalarLoad3(Bytes + 23) << 5;
    s64 A8 = Ed25519ScalarLoad3(Bytes + 26) << 4;
    s64 A9 = (Ed25519ScalarLoad3(Bytes + 29) & 8388607) << 2;
    s64 Carry0;
    s64 Carry1;
    s64 Carry2;
    s64 Carry3;
...
internal void
Ed25519FieldElementPow(ed25519_field_element Output, ed25519_field_element A)
{
    ed25519_field_element t0;
    ed25519_field_element t1;
    ed25519_field_element t2;
    ...
    Ed25519FieldElementMultiply(t0, t1, t0);
    Ed25519FieldElementSquared(t1, t0);
    ...
    Ed25519FieldElementMultiply(t1, t1, t0);
    Ed25519FieldElementSquared(t2, t1);
...
Ed25519GroupElementCompletedToExtended(ed25519_group_element_extended *Extended, ed25519_group_element_completed *Completed)
{
    ...
    Ed25519FieldElementMultiply(Extended->Y, Completed->Y, Completed->Z);
    Ed25519FieldElementMultiply(Extended->Z, Completed->Z, Completed->T);
...
Ed25519GroupElementCompletedToProjective(ed25519_group_element_projective *Projective, ed25519_group_element_completed *Completed)
{
    ...
    Ed25519FieldElementMultiply(Projective->Y, Completed->Y, Completed->Z);
...
Ed25519GroupElementExtendedToProjective(ed25519_group_element_projective *Projective, ed25519_group_element_extended *Extended)
{
    ...
    Ed25519FieldElementCopy(Projective->Y, Extended->Y);
...
Ed25519GroupElementProjectiveDouble(ed25519_group_element_completed *Completed, ed25519_group_element_projective *Projective)
{
    ...
    Ed25519FieldElementSquared(Completed->X, Projective->X);
    Ed25519FieldElementSquared(Completed->Z, Projective->Y);
    Ed25519FieldElementSquared2(Completed->T, Projective->Z);
    Ed25519FieldElementAdd(Completed->Y, Projective->X, Projective->Y);
    Ed25519FieldElementSquared(t0, Completed->Y);
    Ed25519FieldElementAdd(Completed->Y, Completed->Z, Completed->X);
    Ed25519FieldElementSubtract(Completed->Z, Completed->Z, Completed->X);
    Ed25519FieldElementSubtract(Completed->X, t0, Completed->Y);
...
Ed25519GroupElementExtendedDouble(ed25519_group_element_completed *Completed, ed25519_group_element_extended *Extended)
{
    ...
    Ed25519GroupElementExtendedToProjective(&Projective, Extended);
...
Ed25519GroupElementExtendedToCached(ed25519_group_element_cached *Cached, ed25519_group_element_extended *Extended)
{
    ...
    Ed25519FieldElementAdd(Cached->YPlusX, Extended->Y, Extended->X);
    Ed25519FieldElementSubtract(Cached->YMinusX, Extended->Y, Extended->X);
    Ed25519FieldElementCopy(Cached->Z, Extended->Z);
    Ed25519FieldElementMultiply(Cached->T2D, Extended->T, D2);
}

internal void
Ed25519GroupElementScalarMultiply(ed25519_group_element_extended *Extended, u8 *Output)
{
    s8 E[64];
    s8 Carry = 0;
    ed25519_group_element_completed Completed;
    ed25519_group_element_projective Projective;
    ed25519_group_element_precompleted Precompleted;
    ...
    for(s32 Index = 0;
        ...
        ++Index)
    {
        E[2 * Index + 0] = (Output[Index] >> 0) & 15;
        E[2 * Index + 1] = (Output[Index] >> 4) & 15;
    }
    
    // Each E[Index] is between 0 and 15. E[63] is between 0 and 7
    for(s32 Index = 0;
        Index < 63;
        ++Index)
    {
    ...
    E[63] += Carry;
    // Each E[Index] is between -8 and 8
    Ed25519GroupElementExtendedSet0(Extended);
    
    for(u32 Index = 1;
        Index < 64;
        Index += 2)
    {
        Ed25519GroupElementSelect(&Precompleted, Index / 2, E[Index]);
        Ed25519GroupElementMultiplyAdd(&Completed, Extended, &Precompleted);
        Ed25519GroupElementCompletedToExtended(Extended, &Completed);
    }
    
    Ed25519GroupElementExtendedDouble(&Completed, Extended);
    Ed25519GroupElementCompletedToProjective(&Projective, &Completed);
    Ed25519GroupElementProjectiveDouble(&Completed, &Projective);
    Ed25519GroupElementCompletedToProjective(&Projective, &Completed);
    Ed25519GroupElementProjectiveDouble(&Completed, &Projective);
    Ed25519GroupElementCompletedToProjective(&Projective, &Completed);
...
internal void
Ed25519GroupElementExtendedToBytes(u8 *Output, ed25519_group_element_extended *Extended)
{
    ed25519_field_element Recip;
    ed25519_field_element X;
    ed25519_field_element Y;
    Ed25519FieldElementInvert(Recip, Extended->Z);
    Ed25519FieldElementMultiply(X, Extended->X, Recip);
    Ed25519FieldElementMultiply(Y, Extended->Y, Recip);
    Ed25519FieldElementToBytes(Output, Y);
    Output[31] ^= Ed25519FieldElementIsNegative(X) << 7;
}

internal void
Ed25519GroupElementProjectiveToBytes(u8 *Output, ed25519_group_element_projective *Projective)
{
    ed25519_field_element Recip;
    ed25519_field_element X;
    ed25519_field_element Y;
    Ed25519FieldElementInvert(Recip, Projective->Z);
    Ed25519FieldElementMultiply(X, Projective->X, Recip);
    Ed25519FieldElementMultiply(Y, Projective->Y, Recip);
    Ed25519FieldElementToBytes(Output, Y);
    Output[31] ^= Ed25519FieldElementIsNegative(X) << 7;
}

internal b32
Ed25519GroupElementFromBytesNegateVartime(ed25519_group_element_extended *Extended, ed25519_public_key Public)
{
    b32 Result = true;
    
    ed25519_field_element U;
    ed25519_field_element V;
    ed25519_field_element V3;
    ed25519_field_element Vxx;
    ed25519_field_element Check;
    ed25519_field_element D =
    {
        -10913610, 13857413, -15372611, 6949391, 114729, -8787816, -6275908, -3247719, -18696448, -12055116
    };
    ed25519_field_element SqrtM1 =
    {
    ...
    Ed25519FieldElementSubtract(U, U, Extended->Z);     /* U = y^2-1 */
    Ed25519FieldElementAdd(V, V, Extended->Z);     /* V = dy^2+1 */
    Ed25519FieldElementSquared(V3, V);
    Ed25519FieldElementMultiply(V3, V3, V);      /* V3 = V^3 */
    Ed25519FieldElementSquared(Extended->X, V3);
    Ed25519FieldElementMultiply(Extended->X, Extended->X, V);
    Ed25519FieldElementMultiply(Extended->X, Extended->X, U);  /* x = UV^7 */
    Ed25519FieldElementPow(Extended->X, Extended->X); /* x = (UV^7)^((q-5)/8) */
    Ed25519FieldElementMultiply(Extended->X, Extended->X, V3);
    Ed25519FieldElementMultiply(Extended->X, Extended->X, U);  /* x = UV^3(UV^7)^((q-5)/8) */
    Ed25519FieldElementSquared(Vxx, Extended->X);
    Ed25519FieldElementMultiply(Vxx, Vxx, V);
    Ed25519FieldElementSubtract(Check, Vxx, U);  /* Vx^2-U */
    
    if(Ed25519FieldElementIsNonzero(Check))
    {
        Ed25519FieldElementAdd(Check, Vxx, U); /* Vx^2+U */
        ...
        {
            Ed25519FieldElementMultiply(Extended->X, Extended->X, SqrtM1);
        }
    }
    ...
    {    
        ...
        Ed25519FieldElementMultiply(Extended->T, Extended->X, Extended->Y);
    }
...
internal void
Ed25519GroupElementDoubleScalarMultipleVartime(ed25519_group_element_projective *r, u8 *a, ed25519_group_element_extended *A, u8 *b)
{
    /*
    r = a * A + b * B
    ...
    */
    s8 aslide[256];
    s8 bslide[256];
    ed25519_group_element_cached Ai[8]; /* A,3A,5A,7A,9A,11A,13A,15A */
    ed25519_group_element_completed t;
    ed25519_group_element_extended u;
    ed25519_group_element_extended A2;
    s32 i;
    Ed25519ScalarSlide(aslide, a);
    Ed25519ScalarSlide(bslide, b);
    Ed25519GroupElementExtendedToCached(&Ai[0], A);
    Ed25519GroupElementExtendedDouble(&t, A);
    Ed25519GroupElementCompletedToExtended(&A2, &t);
    Ed25519GroupElementAdd(&t, &A2, &Ai[0]);
    Ed25519GroupElementCompletedToExtended(&u, &t);
    Ed25519GroupElementExtendedToCached(&Ai[1], &u);
    Ed25519GroupElementAdd(&t, &A2, &Ai[1]);
    Ed25519GroupElementCompletedToExtended(&u, &t);
    Ed25519GroupElementExtendedToCached(&Ai[2], &u);
    Ed25519GroupElementAdd(&t, &A2, &Ai[2]);
    Ed25519GroupElementCompletedToExtended(&u, &t);
    Ed25519GroupElementExtendedToCached(&Ai[3], &u);
    Ed25519GroupElementAdd(&t, &A2, &Ai[3]);
    Ed25519GroupElementCompletedToExtended(&u, &t);
    Ed25519GroupElementExtendedToCached(&Ai[4], &u);
    Ed25519GroupElementAdd(&t, &A2, &Ai[4]);
    Ed25519GroupElementCompletedToExtended(&u, &t);
    Ed25519GroupElementExtendedToCached(&Ai[5], &u);
    Ed25519GroupElementAdd(&t, &A2, &Ai[5]);
    Ed25519GroupElementCompletedToExtended(&u, &t);
    Ed25519GroupElementExtendedToCached(&Ai[6], &u);
    Ed25519GroupElementAdd(&t, &A2, &Ai[6]);
    Ed25519GroupElementCompletedToExtended(&u, &t);
    ...
    for (; i >= 0; --i) {
        ...
        Ed25519GroupElementCompletedToProjective(r, &t);
    }
}

internal ed25519_key_pair
...
Ed25519Verify(ed25519_signature Signature, string Message, ed25519_public_key Public)
{
    ...
    else if(!Ed25519GroupElementFromBytesNegateVartime(&Extended, Public))
    {
        Result = false;
    }
    else
